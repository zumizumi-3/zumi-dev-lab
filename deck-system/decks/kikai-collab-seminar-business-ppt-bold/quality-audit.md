# Kikai Collab Seminar Bold Bordeaux Quality Audit

This file inherits the source deck quality decisions and adds a visual-direction pass for the bold comparison version. The slide count and source content stay fixed at 34 slides; the visual treatment changes globally.

## Bold Variant Pass

- Larger title, lead, card-heading, and body text hierarchy.
- Bordeaux as the primary accent with Gold as a secondary highlight.
...
- The original `kikai-collab-seminar-business-ppt` deck remains unchanged for side-by-side comparison.
