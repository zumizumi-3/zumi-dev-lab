...
| P07 | kintone Pack Price | Table | kintone Packは、1IDから追加IDまで同じ単価で積み上げる | 通常5,980円/ID、初回契約限定2,980円/ID、初期費用0円、12ヶ月契約、Log Lite移行は対象外、2ID以上はこちら | Price table |
| P08 | ID Pricing | Table + Visual | 2ID以上・追加IDはkintone Packで同じ単価を積み上げる | 1ID / 2ID / 5ID / 10IDの価格例 | Price ladder visual + calculation table |
